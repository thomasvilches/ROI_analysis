...
dc = [1;map(y->119+y,0:24);map(y->177+y,0:14);map(y->287+y,0:16)]#;map(y->105+y,0:34);map(y->199+y,0:12);map(y->258+y,0:9);map(y->285+y,0:12)]#]#]
rc = [1.0;map(y->1.0-(0.13/25)*y,1:25);map(y->0.87+(0.13/15)*y,1:15);map(y->1.0+(0.22/17)*y,1:17)]#;map(y->1.0-(0.108/35)*y,1:35);map(y->0.892+(0.16/13)*y,1:13);map(y->1.052-(0.15/10)*y,1:10);map(y->0.902+(0.28/13)*y,1:13)]#]#]
run_param_scen_cal(0.074,"alabama",10,40,30,1,1,30,1, 1,206,228,1,190,0.2,4,3,14,rc,dc,386,true)
run_param_scen_cal(0.074,"alabama",10,40,30,1,1,30,1, 1,206,228,1,190,0.2,5,3,14,rc,dc,386,false)
...
run_param_scen_cal(true,0.119,"newyorkcity",20,20,1,5,1,1,1,125,999,173,7,999,0.2,1,3,14,rc,dc,435,true)
run_param_scen_cal(true,0.119,"newyorkcity",20,20,1,5,1,1,1,125,999,173,7,999,0.2,2,3,14,rc,dc,435,false)
...
dc = [1;map(y->119+y,0:24);map(y->177+y,0:14);map(y->287+y,0:16)]#;map(y->105+y,0:34);map(y->199+y,0:12);map(y->258+y,0:9);map(y->285+y,0:12)]#]#]
rc = [1.0;map(y->1.0-(0.13/25)*y,1:25);map(y->0.87+(0.13/15)*y,1:15);map(y->1.0+(0.22/17)*y,1:17)]#;map(y->1.0-(0.108/35)*y,1:35);map(y->0.892+(0.16/13)*y,1:13);map(y->1.052-(0.15/10)*y,1:10);map(y->0.902+(0.28/13)*y,1:13)]#]#]
run_param_scen_cal(true,0.074,"alabama",10,40,30,1,1,30,1, 1,206,228,1,190,0.2,1,3,14,rc,dc,365,true)
...
run_param_scen_cal(true,0.119,"newyorkcity",20,20,1,5,1,1,1,125,999,173,7,999,0.2,1,2,14,rc,dc,435,true)
run_param_scen_cal(true,0.119,"newyorkcity",20,20,1,5,1,1,1,125,999,173,7,999,0.2,2,2,14,rc,dc,435,false)
