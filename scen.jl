...
dc = [1;map(y-> 95+y,0:3);map(y->131+y,0:9);map(y->166+y,0:13);map(y->198+y,0:30);map(y->285+y,0:19);map(y->315+y,0:19)]#;map(y->98+y,0:22);map(y->195+y,0:4);map(y->224+y,0:59);map(y->298+y,0:19)]
rc = [1.0;map(y-> 1.0-(0.054/4)*y,1:4);map(y-> 0.946-(0.046/10)*y,1:10);map(y-> 0.90+(0.05/14)*y,1:14);map(y-> 0.95-(0.2945/31)*y,1:31);map(y-> 0.6555+(0.3645/20)*y,1:20);map(y-> 1.0-(0.115/20)*y,1:20)]#;map(y->1.0-(0.143/23)*y,1:23);map(y->0.857+(0.04/5)*y,1:5);map(y->0.897-(0.29/60)*y,1:60);map(y->0.607+(0.30/20)*y,1:20)]
